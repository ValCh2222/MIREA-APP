...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery,R.id.nav_apparat,R.id.nav_camera, R.id.nav_slideshow,R.id.nav_playMusic, R.id.nav_calculateFragment, R.id.nav_webViewFragment)
